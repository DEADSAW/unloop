...
@androidx.room.Entity(tableName = "songs", indices = {@androidx.room.Index(value = {"artist"}), @androidx.room.Index(value = {"lastPlayedAt"}), @androidx.room.Index(value = {"platform"}), @androidx.room.Index(value = {"firstPlayedAt"}), @androidx.room.Index(value = {"playCount"}), @androidx.room.Index(value = {"isWhitelisted"}), @androidx.room.Index(value = {"isBlacklisted"})})
